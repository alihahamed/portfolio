...
export default function Document() {
  return (
    <div className="w-full h-full flex flex-col justify-between relative text-[#AB1509]" style={{ padding: "5%" }}>
      ...
      <div className="absolute top-[13%] bottom-0 w-[1px] bg-[#AB1509] pointer-events-none" style={{ left: "50%" }} />
      {/* Header horizontal line */}
      <div className="absolute left-0 right-0 h-[1px] bg-[#AB1509] pointer-events-none" style={{ top: "13%" }} />
      {/* Middle horizontal line (right side) */}
      <div className="absolute right-0 h-[1px] bg-[#AB1509] pointer-events-none" style={{ left: "50%", top: "59%" }} />
      {/* Lower horizontal line (right side) */}
      <div className="absolute right-0 h-[1px] bg-[#AB1509] pointer-events-none" style={{ left: "50%", top: "75%" }} />

      {/* HEADER (Top Section) */}
      <div className="flex items-center justify-between z-10" style={{ height: "9%", paddingLeft: "1%", paddingRight: "1%" }}>
        <div className="flex items-baseline" style={{ gap: "0.8vh" }}>
          <h1 className="text-[6.5vw] md:text-[9vh] font-medium font-tusker-standard tracking-tight leading-none">About.</h1>
      ...
      {/* MAIN CONTENT AREA */}
      <div className="flex-1 z-10 overflow-hidden font-montreal font-medium" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8%", marginTop: "4%", height: "87%" }}>
        {/* LEFT COLUMN (Education & Experience) */}
        <div className="flex flex-col justify-between h-full">
          {/* EDUCATION */}
          <div>
            <h2 className="text-[3.2vw] md:text-[2vh] font-medium uppercase tracking-wide font-montreal" style={{ marginBottom: "3%" }}>Education</h2>
            <div className="flex flex-col" style={{ gap: "4%" }}>
              <div style={{ marginBottom: "3%" }}>
                <h3 className="text-[2.2vw] md:text-[1.4vh] font-medium leading-tight">Undergraduate - Creative Tech</h3>
                <p className="text-[1.6vw] md:text-[1.2vh] font-medium opacity-80">College of Design & Tech (2021 - 2025)</p>
              </div>
              <div style={{ marginBottom: "3%" }}>
                <h3 className="text-[2.2vw] md:text-[1.4vh] font-medium leading-tight">High School</h3>
                <p className="text-[1.6vw] md:text-[1.2vh] font-medium opacity-80">Girideepam Central School (2018 - 2021)</p>
              </div>
              <div>
                <h3 className="text-[2.2vw] md:text-[1.4vh] font-medium leading-tight">Primary School</h3>
                <p className="text-[1.6vw] md:text-[1.2vh] font-medium opacity-80">Our Own English High School, Dubai</p>
              </div>
            </div>
          </div>
        ...
        {/* RIGHT COLUMN (Photo, Profile, contact, Interests/Languages, Skills) */}
        <div className="flex flex-col justify-between h-full">
          ...
          <div>
            ...
            <div className="flex items-baseline" style={{ marginTop: "3%" }}>
              <h2 className="text-[4.5vw] md:text-[2.6vh] font-bold tracking-tight uppercase leading-none font-montreal">
                <span className="text-[7vw] md:text-[4vh] font-bold">A</span>li <span className="text-[7vw] md:text-[4vh] font-bold">A</span>hmed
              </h2>
            </div>

            <div style={{ marginTop: "3%" }}>
              <h3 className="text-[2.2vw] md:text-[1.5vh] font-bold uppercase tracking-wider font-montreal" style={{ marginBottom: "1%" }}>Profile</h3>
              <p className="text-[1.6vw] md:text-[1.2vh] leading-tight font-medium">
            ...
            <div className="flex flex-col" style={{ marginTop: "3%" }}>
              <span className="text-[2.2vw] md:text-[1.5vh] font-bold uppercase tracking-wider font-montreal">contact</span>
              <span className="text-[1.6vw] md:text-[1.2vh] font-medium">email : aliahmed.dev@gmail.com</span>
              <span className="text-[1.6vw] md:text-[1.2vh] font-medium">phone : +971 50 123 4567</span>
            </div>
          </div>
